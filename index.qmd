...
# Add text annotations for means
ax.text(len(patients_randomized_df) * 0.95, dreamy_mean, f'○ {dreamy_mean:.2f}', 
        color='#4E79A7', fontsize=11, fontweight='bold', 
        verticalalignment='center', horizontalalignment='right', 
        bbox=dict(boxstyle='round,pad=0.3', facecolor='white', alpha=0.8), zorder=4)
ax.text(len(patients_randomized_df) * 0.95, duck_mean, f'△ {duck_mean:.2f}', 
        color='#E15759', fontsize=11, fontweight='bold', 
        verticalalignment='center', horizontalalignment='right',
        bbox=dict(boxstyle='round,pad=0.3', facecolor='white', alpha=0.8), zorder=4)
...
# Get x-axis limits after all plotting and styling is complete
plt.tight_layout()
xlim = ax.get_xlim()
x_max = xlim[1]

# Add text annotations for means positioned on the right side of the graph
ax.text(x_max * 0.98, dreamy_mean, f'○ {dreamy_mean:.2f}', 
        color='#4E79A7', fontsize=11, fontweight='bold', 
        verticalalignment='center', horizontalalignment='right', 
        bbox=dict(boxstyle='round,pad=0.3', facecolor='white', alpha=0.8), zorder=4)
ax.text(x_max * 0.98, duck_mean, f'△ {duck_mean:.2f}', 
        color='#E15759', fontsize=11, fontweight='bold', 
        verticalalignment='center', horizontalalignment='right',
        bbox=dict(boxstyle='round,pad=0.3', facecolor='white', alpha=0.8), zorder=4)
